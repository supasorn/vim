...
hi Linenr      guibg=#2a1c0e	guifg=#aaaaaa  gui=none ctermbg=bg ctermfg=7
...
hi VertSplit	  guibg=#cc4455	 guifg=#f38493 gui=none ctermbg=4  ctermfg=11
...
hi String      guibg=bg	   guifg=#99cc99  gui=italic  ctermbg=bg  ctermfg=14
hi Character   guibg=bg	   guifg=#ffffcc  gui=bold    ctermbg=bg  ctermfg=14
hi Number      guibg=bg	   guifg=#95cce3  gui=bold    ctermbg=1   ctermfg=15
...
hi Function    guibg=bg    guifg=#f4cc6b  gui=bold    ctermbg=bg  ctermfg=12
hi Statement   guibg=bg    guifg=#fefab8  gui=bold    ctermbg=bg  ctermfg=14
...
hi Include	  guibg=bg	 guifg=#95cce3	gui=bold ctermbg=bg ctermfg=10
